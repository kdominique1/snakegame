...
class AvoidWallsPlayer extends Player {
    ...
    makeTurn() {
        ...
        */
        if ((this.sc.snakeDirection === -1 && this.sc.snakePosition.x === 0 && this.sc.snakePosition.y < this.sc.worldHeight) || (this.sc.snakeDirection === 2 && this.sc.snakePosition.y <= 0 && this.sc.snakePosition.x < this.sc.worldWidth/2) || (this.sc.snakeDirection == 0 && this.sc.snakePosition.y >= this.sc.worldHeight && this.sc.snakePosition.x >= this.sc.worldWidth/2)) {
        ...
        */
        else if ((this.sc.snakeDirection === 0 && this.sc.snakePosition.y >= this.sc.worldHeight) || (this.sc.snakeDirection === 1 && this.sc.snakePosition.x >= this.sc.worldWidth && this.sc.snakePosition.y > 0) || (this.sc.snakeDirection === 2 && this.sc.snakePosition.y <= 0 && this.sc.snakePosition.x >= this.sc.worldWidth/2)) {
